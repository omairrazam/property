...
json.options do
	...
	json.care_of_id User.all.map{|u|{label:u.username, value: u.id}}.unshift({label:'Pick a C/O', value:-1})
	json.trader_id User.all.map{|u|{label:u.username, value: u.id}}.unshift({label:'Pick a Trader', value:-1})
